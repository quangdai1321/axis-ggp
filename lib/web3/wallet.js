...
// Wipes every bit of WalletConnect's own persisted state (pairing topic,
// session, relay keys — all namespaced under "wc@2:..." in localStorage).
// Called on cancel/error and on every fresh page load so a broken or
// half-open session from a previous attempt never gets silently reused.
